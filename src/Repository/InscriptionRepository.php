...
class InscriptionRepository extends ServiceEntityRepository
{
   ...
   public function verifInscription($id): array
   {
       return $this->createQueryBuilder('inscription')
           ->andWhere('inscription.laFormation = :id')
           ->setParameter('id', $id)
           ->setMaxResults(10)
           ->getQuery()
           ->getResult()
...
//FROM inscription
//GROUP BY la_formation_id
//ORDER BY COUNT(inscription.id) DESC;
   
//    public function PlusDemande(): array
//    {
//        return $this->createQueryBuilder('i')
//             ->groupBy('i.laFormation.id')
